    ...
    return (
        <div className="clist flex flex-row gap-6 p-5">
            ...
            <div className="clist-details flex flex-row gap-10">
                <div className="flex flex-col clist-short-detail p-2">
                ...
                <div className="flex flex-col clist-more-detail">
                    ...
                    <button className="register-button p-2" onClick={()=>setToggle(!toggle)}>{toggle?"Registered..!":"Register Here"}</button>
                </div>
            </div>
        </div>
    )
